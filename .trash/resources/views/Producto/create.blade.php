 ...
 <section class="content">
  ...
  <div class="col-md-12">
       ...
       <div class="row">
        <div class="col-xs-6 col-sm-6 col-md-6">
         <div class="form-group">
          <input type="text" name="cod_prov1" id="cod_prov1" class="form-control input-sm" placeholder="Cod proveedor1">
         </div>
        </div>
        <div class="row">
        <div class="col-xs-6 col-sm-6 col-md-6">
         <div class="form-group">
          <input type="text" name="cod_prov2" id="cod_prov2" class="form-control input-sm" placeholder="Cod proveedor2">
          </div>
         </div>
        </div>
        <div class="col-xs-6 col-sm-6 col-md-6">
