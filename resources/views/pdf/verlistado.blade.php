...
<div class="table-responsive">
        <table id="mytable" class="table table-bordred table-striped small">
             <thead>
               <th scope="col">Codigo</th>
              <th scope="col">Categoria</th>
               <th scope="col">Producto/Reemplazo</th>
    ...
    <ul class="navbar-nav mr-auto">
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          ...
          <a class="dropdown-item" href="{{ route('verlista', ['search' => 'CAMPOS NUEVO'])}}">CAMPOS NUEVOS - CARCAZAS</a>
          ...
          <a class="dropdown-item" href="{{ route('verlista', ['search' => 'IMPULSORES NUEVOS'])}}">IMPULSORES - BENDIX NUEVOS</a>
            <a class="dropdown-item" href="{{ route('verlista', ['search' => 'IMPULSORES REPARADOS'])}}">IMPULSORES - BENDIX REPARADOS</a>
          ...
          <a class="dropdown-item" href="{{ route('verlista', ['search' => 'VARIOS'])}}">VARIOS</a>
</div>
        </div>
      </li>
    </ul>
