...
<div class="row">
       ...
       <div class="row">
        <div class="col-xs-6 col-sm-6 col-md-6">
         <div class="form-group">
          <input type="text" name="codigo" id="codigo" class="form-control input-sm" value="{{$producto->codigo}}" placeholder="Codigo producto DAL">
         </div>
        </div>
        <div class="col-xs-6 col-sm-6 col-md-6">
         <div class="form-group">
          <input type="text" name="producto" id="producto" class="form-control input-sm" value="{{$producto->producto}}" placeholder="Producto / Reemplazo">
         </div>
        </div>
       </div>
 ...
 <div class="col-md-12">
            <select name="categoria" class="form-control input-sm"  placeholder="categoria" value="{{$producto->categoria}}">
              ...
              <option value="CAMPOS NUEVOS-CARCAZAS">CAMPOS NUEVOS - CARCAZAS</option>
       ...
       <div class="row">
        <div class="col-xs-6 col-sm-6 col-md-6">
         <div class="form-group">
          <input type="text" name="cod_prov1" id="cod_prov1" class="form-control input-sm" value="{{$producto->cod_prov1}}" placeholder="Codigo DIPRA">
         </div>
        </div>
        <div class="col-xs-6 col-sm-6 col-md-6">
         <div class="form-group">
          <input type="text" name="cod_prov2" id="cod_prov2" class="form-control input-sm" value="{{$producto->cod_prov2}}" placeholder="Codigo GV">
         </div>
        </div>
       </div>
       ...
       <div class="row">
        <div class="col-xs-6 col-sm-6 col-md-6">
         <div class="form-group">
          <input type="text" name="precio" id="precio" class="form-control input-sm" value="{{$producto->precio}}" placeholder="Precio $">
         </div>
        </div>
        <div class="col-xs-6 col-sm-6 col-md-6">
         <div class="form-group">
          <input type="text" name="precio_uss" id="precio_uss" class="form-control input-sm" value="{{$producto->precio_uss}}" placeholder="PRECIO U$S">
         </div>
        </div>
       </div>
