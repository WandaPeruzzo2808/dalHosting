     ...
     <div class="table-container">
      <form method="POST" action="{{ route('libro.update',$libro->id) }}"  role="form">
       ...
       <div class="row">
        ...
        <div class="col-xs-6 col-sm-6 col-md-6">
         <div class="form-group">
          <input type="text" name="dato_contacto" id="dato_contacto" class="form-control input-sm" value="{{$libro->dato_contacto}}">
         </div>
        </div>
       </div>
       ...
       <div class="row">
        <div class="col-xs-6 col-sm-6 col-md-6">
         <div class="form-group">
          <input type="text" name="f_pedido" id="f_pedido" class="form-control input-sm" value="{{$libro->f_pedido}}">
         </div>
        </div>
        <div class="col-xs-6 col-sm-6 col-md-6">
         <div class="form-group">
       ...
       <div class="form-group">
        <textarea name="dire_entrega" class="form-control input-sm" placeholder="dire_entrega">{{$libro->dire_entrega}}</textarea>
       </div>
       <div class="row">
